...
***** [[knight-metric-description][Knight Metric]]
     ...
     | x | y | expected | js                  |
     |---+---+----------+---------------------|
     | 3 | 6 |        3 | expected 3, found 5 |
     | 1 | 2 |        1 | expected 1, found 3 |
     | 5 | 7 |        4 | expected 4, found 2 |
     | 5 | 4 |        3 | pass                |
     #+TBLFM: $4 = '(org-sbe "knight-metric-js-caller" (x $1) (y $2))::$4 ='(org-sbe "generic-tester" (expected $3) (result $4))
     #+LATEX: }
     #+END_TABLE

    As one can see from [[tbl:knight-metric]], either the algorithm is
    wrong or the implementations is.
