...
#+BEGIN_SRC emacs-lisp :var result="" :var expected="" :exports none
  (if (equal expected result) "pass" (format "it was %S" result))
#+END_SRC
...
**** Implementations
     ...
     #+CAPTION: Python solution \cite{Komanec:2016:Codility:Gist}
...
**** Design
     ...
     1. convert the number to decimal by using the regular [[http://mathworld.wolfram.com/Base.html][positional
        ...
        Therefore, the negabinary expansion of 13 is 11101. \cite{FactIndex:2016:Negabinary}
        #+END_QUOTE
